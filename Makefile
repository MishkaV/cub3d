...
#    Updated: 2021/04/23 12:34:45 by jbenjy           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS			= $(DIR_SRCS)cub3d.c \
				...
				$(DIR_UTILS)checks_map_more.c \
				$(DIR_UTILS)checks_map_more2.c \
				$(DIR_UTILS)load_texture.c \
				$(DIR_UTILS)inits.c \
				$(DIR_UTILS)inits_more.c \
				$(DIR_UTILS)press_key.c \
				$(DIR_UTILS)press_key_more.c \
				$(DIR_SCENE)scene.c \
				...
				$(DIR_SCENE)color.c \
				$(DIR_SCENE)more_fun.c \
				$(DIR_LIST)list.c \
				$(DIR_LIST)list_sprite.c \
				$(DIR_RAY)floor_ceil.c \
				$(DIR_RAY)paint.c \
				$(DIR_RAY)sprites_utils.c \
				$(DIR_RAY)raycasting_utils.c \
				$(DIR_RAY)throw_ray.c \
				$(DIR_BMP)create_bmp.c \
